-- =====================================================
-- STEP 3: Final Revert Script for Migrations 021-028
...
-- IMPORTANT: Check your bb_* migrations first!
-- If bb_* tables use these enums with different names, these can be dropped.
-- If bb_* tables use these same enum names, DO NOT drop them!

-- Uncomment these ONLY if Step 2 shows they exist AND they're not used by bb_* tables:
