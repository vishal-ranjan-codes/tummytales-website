-- =====================================================
-- STEP 3: Complete Revert Script for Migrations 021-028
-- Based on actual migration content analysis
-- WARNING: Create backup first!
-- =====================================================
...
-- Drop policies for tables we're about to drop
-- (They'll also be dropped with CASCADE, but being explicit)
...
-- =====================================================
-- STEP 5: Drop Types/Enums (if they exist and aren't used elsewhere)
-- =====================================================

-- IMPORTANT: Only drop these if they're NOT used by bb_* tables
-- Check Step 2 results first! If bb_* tables use these enums, DO NOT drop them.

-- Check if these types are used by bb_* tables before dropping
-- If Step 2 shows these enums exist AND they're not used by bb_* tables, uncomment to drop:
...
-- Note: We're keeping these commented out for safety.
-- If your bb_* tables use different enum names (like bb_invoice_status), 
-- then these can be safely dropped. Check your bb_* migrations first!
