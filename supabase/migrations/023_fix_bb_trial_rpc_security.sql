-- =====================================================
-- BELLYBOX - FIX BB TRIAL RPC FUNCTION SECURITY
-- Migration: 023_fix_bb_trial_rpc_security.sql
-- Description: Add SECURITY DEFINER to bb_create_trial_checkout to bypass RLS
-- =====================================================

-- Fix bb_create_trial_checkout to use SECURITY DEFINER
-- This allows the function to insert into bb_trial_meals, bb_trials, bb_invoices, etc.
...
DECLARE
    ...
    i INTEGER;
BEGIN
    -- Security check: Validate consumer_id matches authenticated user
...
-- Add comment
COMMENT ON FUNCTION bb_create_trial_checkout IS 'Creates trial, trial meals, and invoice. Uses SECURITY DEFINER to bypass RLS for system operations. Validates that consumer_id matches authenticated user.';
