    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="theme-fc-light">
          Deliver orders and earn with flexible schedules
        </p>
      </div>
          ...
          <>
            ...
            {showOAuth && (
              <div className="space-y-3">
                <GoogleButton text="Continue with Google" redirectTo={`${typeof window !== 'undefined' ? window.location.origin : ''}/auth/callback?role=rider`} />
              </div>
            )}
