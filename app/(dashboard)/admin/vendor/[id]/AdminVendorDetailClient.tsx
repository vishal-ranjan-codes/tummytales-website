    ...
    <div className="dashboard-page-content space-y-6">
      ...
      <div className="dashboard-page-header flex items-center justify-between flex-wrap gap-4 border-b theme-border-color px-4 py-3 md:py-5 md:px-3 lg:px-6 lg:py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="theme-h4">{vendor.display_name}</h1>
            <p className="theme-fc-light mt-1">Vendor ID: {vendor.id}</p>
          </div>
        </div>
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          <div className="theme-bg-color-dark rounded-sm p-1 overflow-x-auto">
            <TabsList className="inline-flex h-auto bg-transparent p-0 gap-1 w-auto min-w-fit">
              <TabsTrigger value="overview" className="flex-none !theme-rounded-sm data-[state=active]:bg-white data-[state=active]:text-primary-100 data-[state=active]:shadow-sm whitespace-nowrap cursor-pointer">Overview</TabsTrigger>
              <TabsTrigger value="media" className="flex-none !theme-rounded-sm data-[state=active]:bg-white data-[state=active]:text-primary-100 data-[state=active]:shadow-sm whitespace-nowrap cursor-pointer">Media</TabsTrigger>
              <TabsTrigger value="documents" className="flex-none !theme-rounded-sm data-[state=active]:bg-white data-[state=active]:text-primary-100 data-[state=active]:shadow-sm whitespace-nowrap cursor-pointer">Documents</TabsTrigger>
              <TabsTrigger value="meals" className="flex-none !theme-rounded-sm data-[state=active]:bg-white data-[state=active]:text-primary-100 data-[state=active]:shadow-sm whitespace-nowrap cursor-pointer">Meals ({meals.length})</TabsTrigger>
            </TabsList>
          </div>
